...
use App\Livewire\Forms\Evento\EventoLocalForm;
...
class EventoLocalIndex extends Component
{
    ...
    public EventoLocalForm $form;
    public $registro_id = '';
    public $page_title = 'Evento Locais';

    /* Renderiza componente */
    #[Title('Evento Locais')]
    public function render()
    {
        return view('livewire.evento.evento-local-index',[
            'headers' => $this->headers(),
            'evento_locals' => $this->evento_locals(),
        ]);
    }

    // Método p/ obter dados da tabela
    public function evento_locals()
    {
