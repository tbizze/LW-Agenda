...
use App\Livewire\Forms\Evento\EventoGrupoForm;
...
class EventoGrupoIndex extends Component
{
    ...
    public EventoGrupoForm $form;
    public $registro_id = '';
    public $page_title = 'Evento Grupos';

    /* Renderiza componente */
    #[Title('Evento Grupos')]
    public function render()
    {
        return view('livewire.evento.evento-grupo-index',[
            'headers' => $this->headers(),
            'evento_grupos' => $this->evento_grupos(),
        ]);
    }

    // Método p/ obter dados da tabela
    public function evento_grupos()
    {
        return EventoGrupo::query()
